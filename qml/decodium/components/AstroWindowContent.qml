        ...
        Rectangle {
            ...
            RowLayout {
                ...
                Text {
                    ...
                    font.pixelSize: 14; font.bold: true; font.family: decodiumMonoFontFamily; color: primaryBlue
                }
                ...
                Text {
                    ...
                    font.pixelSize: 11; font.family: decodiumMonoFontFamily; color: textPrimary
                }
                ...
                ColumnLayout {
                    ...
                    GridLayout {
                        ...
                        Text {
                            ...
                            color: textPrimary; font.pixelSize: 12; font.family: decodiumMonoFontFamily
                        }
                        ...
                        Text {
                            ...
                            color: moonColor; font.pixelSize: 12; font.family: decodiumMonoFontFamily
                        }
                    }
                }
            }

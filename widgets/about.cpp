  ...
  ui(new Ui::CAboutDlg)
{
  ...
  ui->labelTxt->setText(
    ...
    "<p><b>Fork " FORK_RELEASE_VERSION " highlights:</b> macOS Preferences handling fixed across all UI languages, "
    "scroll-safe Settings on macOS, persistent `jt9_subprocess.log` diagnostics for FT2 decoder failures, "
    "automatic FT2 ADIF 3.17 migration to `MODE=MFSK` + `SUBMODE=FT2`, stronger audio-start recovery, "
    "and the experimental RTTY UI withdrawn from public access pending validation.</p>"
    "<hr>"

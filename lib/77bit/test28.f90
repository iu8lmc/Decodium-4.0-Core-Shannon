...
1000 format('Encoded text   Recovered text      n28 Err?   Type'/60('-'))
  ...
  do iline=1,999999
     ...
     call_1='             '
     call_00=call_0
     call ftx_pack77_pack28(call_00,n28)
     call ftx_pack77_unpack28(n28,call_1,unpk28_success)
     cerr=' '
...
1010 format(a13,2x,a13,i10,2x,a1,2x,'Special token')
     if(n28.ge.NTOKENS .and. n28.lt.NTOKENS+MAX22) then
        call_00=call_0
        call ftx_pack77_save_hash_call(call_00,n10,n12,n22)
...
100 call ftx_pack77_unpack28(n28,call_1,unpk28_success)
  cerr=' '

...
public:
    ...
    explicit BandManager(QObject* parent = nullptr) : QObject(parent)
    {
        ...
        m_bands = {
            ...
            { 16, "4M",   "70 MHz",    70000000.0,  71000000.0,  70154000.0,  70157000.0,       0.0   },
            { 17, "2M",   "144 MHz",  144000000.0, 148000000.0, 144174000.0, 144177000.0, 144170000.0 },
            { 19, "70CM", "432 MHz",  420000000.0, 450000000.0, 432174000.0, 432177000.0,       0.0   },
        };
    }
